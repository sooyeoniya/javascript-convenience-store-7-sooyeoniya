...
### 기능
  ...
  **파일 입출력**
  - [ ] `public/products.md`을 통해 상품 목록 저장
  - [ ] `public/promotions.md`을 통해 행사 목록 저장
...
### 출력
  ...
  - [ ] 환영 인사와 함께 상품명, 가격, 프로모션 이름, 재고 안내 출력
    - [ ] 만약 재고가 `0`개일 경우 `재고 없음` 출력
    - [ ] `public/products.md`에서 각 상품 중 프로모션 재고만 나와 있는 경우, `재고 없음`으로 일반 재고 출력
